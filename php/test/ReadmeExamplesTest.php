...
// Moogleapi SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MoogleapiSDK::test)
...
{
    private const SDK_CLASS = 'MoogleapiSDK';
    ...
    private const SDK_BASE = 'moogleapi_sdk';
