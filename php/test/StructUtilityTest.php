...
// Moogleapi SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MoogleapiOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MoogleapiOmni::structfix($now, Struct::undef()))
                        !== json_encode(MoogleapiOmni::structfix($val, Struct::undef()))) {
