...
class MoogleApiWebFeaturesCharactersGetGetCharacterEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        $moogle_api_web_features_characters_get_get_character_ref01_data_dt0_load_result = Helpers::to_map(is_object($moogle_api_web_features_characters_get_get_character_ref01_data_dt0_loaded) && method_exists($moogle_api_web_features_characters_get_get_character_ref01_data_dt0_loaded, 'data_get') ? $moogle_api_web_features_characters_get_get_character_ref01_data_dt0_loaded->data_get() : $moogle_api_web_features_characters_get_get_character_ref01_data_dt0_loaded);
