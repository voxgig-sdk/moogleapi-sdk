...
class MoogleapiTestRunner
{
    ...
    {
        $live = self::getenv('MOOGLEAPI_TEST_LIVE');
        $override = self::getenv('MOOGLEAPI_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MOOGLEAPI_TEST_EXPLAIN');
...
class_alias('MoogleapiTestRunner', 'Runner');
class_alias('MoogleapiHelpers', 'Helpers');
