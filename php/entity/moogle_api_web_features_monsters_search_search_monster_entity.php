...
class MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "moogle_api_web_features_monsters_search_search_monster";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity($this->_client, $opts);
    }

    /**
     * @param MoogleApiWebFeaturesMonstersSearchSearchMonster|array $args MoogleApiWebFeaturesMonstersSearchSearchMonster data (assoc-array) to store.
     */
    ...
    /**
     * @return MoogleApiWebFeaturesMonstersSearchSearchMonster|array The current MoogleApiWebFeaturesMonstersSearchSearchMonster data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MoogleApiWebFeaturesMonstersSearchSearchMonster fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MoogleApiWebFeaturesMonstersSearchSearchMonster fields).
     */
    ...
    /**
     * List MoogleApiWebFeaturesMonstersSearchSearchMonster items matching the given filter.
     *
     * @param MoogleApiWebFeaturesMonstersSearchSearchMonsterListMatch|array|null $reqmatch Match filter (any subset
     *   of MoogleApiWebFeaturesMonstersSearchSearchMonster fields) as an assoc-array; MoogleApiWebFeaturesMonstersSearchSearchMonsterListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MoogleApiWebFeaturesMonstersSearchSearchMonster[]|array A list of MoogleApiWebFeaturesMonstersSearchSearchMonster items as assoc-arrays at
