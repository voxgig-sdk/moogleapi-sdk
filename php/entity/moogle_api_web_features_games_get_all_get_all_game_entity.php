...
class MoogleApiWebFeaturesGamesGetAllGetAllGameEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "moogle_api_web_features_games_get_all_get_all_game";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MoogleApiWebFeaturesGamesGetAllGetAllGameEntity($this->_client, $opts);
    }

    /**
     * @param MoogleApiWebFeaturesGamesGetAllGetAllGame|array $args MoogleApiWebFeaturesGamesGetAllGetAllGame data (assoc-array) to store.
     */
    ...
    /**
     * @return MoogleApiWebFeaturesGamesGetAllGetAllGame|array The current MoogleApiWebFeaturesGamesGetAllGetAllGame data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MoogleApiWebFeaturesGamesGetAllGetAllGame fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MoogleApiWebFeaturesGamesGetAllGetAllGame fields).
     */
    ...
    /**
     * List MoogleApiWebFeaturesGamesGetAllGetAllGame items matching the given filter.
     *
     * @param MoogleApiWebFeaturesGamesGetAllGetAllGameListMatch|array|null $reqmatch Match filter (any subset
     *   of MoogleApiWebFeaturesGamesGetAllGetAllGame fields) as an assoc-array; MoogleApiWebFeaturesGamesGetAllGetAllGameListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MoogleApiWebFeaturesGamesGetAllGetAllGame[]|array A list of MoogleApiWebFeaturesGamesGetAllGetAllGame items as assoc-arrays at
