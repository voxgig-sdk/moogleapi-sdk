...
class MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "moogle_api_web_features_characters_get_all_get_all_character";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity($this->_client, $opts);
    }

    /**
     * @param MoogleApiWebFeaturesCharactersGetAllGetAllCharacter|array $args MoogleApiWebFeaturesCharactersGetAllGetAllCharacter data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = MoogleapiHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return MoogleApiWebFeaturesCharactersGetAllGetAllCharacter|array The current MoogleApiWebFeaturesCharactersGetAllGetAllCharacter data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MoogleApiWebFeaturesCharactersGetAllGetAllCharacter fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = MoogleapiHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of MoogleApiWebFeaturesCharactersGetAllGetAllCharacter fields).
     */
    ...
    /**
     * List MoogleApiWebFeaturesCharactersGetAllGetAllCharacter items matching the given filter.
     *
     * @param MoogleApiWebFeaturesCharactersGetAllGetAllCharacterListMatch|array|null $reqmatch Match filter (any subset
     *   of MoogleApiWebFeaturesCharactersGetAllGetAllCharacter fields) as an assoc-array; MoogleApiWebFeaturesCharactersGetAllGetAllCharacterListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MoogleApiWebFeaturesCharactersGetAllGetAllCharacter[]|array A list of MoogleApiWebFeaturesCharactersGetAllGetAllCharacter items as assoc-arrays at
     *   the SDK boundary; throws MoogleapiError on failure (item-5 convention).
     */
