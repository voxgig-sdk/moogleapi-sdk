...
// Moogleapi SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MoogleapiTestFeature extends MoogleapiBaseFeature
{
    ...
    public function init(MoogleapiContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MoogleapiContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = MoogleapiParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MoogleapiContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MoogleapiContext $ctx, $op, $args): array
    {
