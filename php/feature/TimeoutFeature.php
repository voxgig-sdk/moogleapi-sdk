...
class MoogleapiTimeoutFeature extends MoogleapiBaseFeature
{
    ...
    private function _with_timeout(MoogleapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MoogleapiContext $_ctx, float $ms): void
    {
        $client = $this->client;
