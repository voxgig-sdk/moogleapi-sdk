...
// Moogleapi SDK utility: fetcher

class MoogleapiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MoogleapiSDK/1.0)';
    ...
    public static function call(MoogleapiContext $ctx, string $fullurl, array $fetchdef): array
    {
