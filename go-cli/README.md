...
AQL-driven command-line client **and** interactive REPL for the Moogleapi
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `moogle_api_web_features_characters_get_all_get_all_character`).
