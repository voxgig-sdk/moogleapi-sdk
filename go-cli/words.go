...
func registerSDKWords(r *eng.Registry, client *sdk.MoogleapiSDK) {
...
func runOp(client *sdk.MoogleapiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
