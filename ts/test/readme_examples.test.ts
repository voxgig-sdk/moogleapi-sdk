...
//     (\`new MoogleapiSDK(...)\` / \`MoogleapiSDK.test(...)\` become
//     \`MoogleapiSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const TEST_SEED = {"entity":{"moogle_api_web_features_characters_get_all_get_all_character":{"test01":{"id":"test01"}},"moogle_api_web_features_characters_get_get_character":{"test01":{"id":"test01"}},"moogle_api_web_features_characters_search_search_character":{"test01":{"id":"test01"}},"moogle_api_web_features_games_get_all_get_all_game":{"test01":{"id":"test01"}},"moogle_api_web_features_games_get_get_game":{"test01":{"id":"test01"}},"moogle_api_web_features_monsters_get_all_get_all_monster":{"test01":{"id":"test01"}},"moogle_api_web_features_monsters_get_get_monster":{"test01":{"id":"test01"}},"moogle_api_web_features_monsters_search_search_monster":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new MoogleapiSDK(...)\` and any
// \`MoogleapiSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+MoogleapiSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/MoogleapiSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
