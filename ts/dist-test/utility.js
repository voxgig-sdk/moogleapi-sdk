...
function envOverride(m) {
    if ('TRUE' === process.env.MOOGLEAPI_TEST_LIVE ||
        'TRUE' === process.env.MOOGLEAPI_TEST_OVERRIDE) {
    ...
    m.MOOGLEAPI_TEST_EXPLAIN = process.env.MOOGLEAPI_TEST_EXPLAIN || m.MOOGLEAPI_TEST_EXPLAIN;
    return m;
}
