...
(0, node_test_1.describe)('MoogleApiWebFeaturesCharactersGetGetCharacterDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-moogle_api_web_features_characters_get_get_character', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-moogle_api_web_features_characters_get_get_character', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MOOGLEAPI_TEST_MOOGLE_API_WEB_FEATURES_CHARACTERS_GET_GET_CHARACTER_ENTID'];
...
//# sourceMappingURL=MoogleApiWebFeaturesCharactersGetGetCharacterDirect.test.js.map