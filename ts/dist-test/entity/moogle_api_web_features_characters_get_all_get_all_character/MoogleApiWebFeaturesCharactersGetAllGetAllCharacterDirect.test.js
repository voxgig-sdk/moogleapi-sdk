...
(0, node_test_1.describe)('MoogleApiWebFeaturesCharactersGetAllGetAllCharacterDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-moogle_api_web_features_characters_get_all_get_all_character', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-moogle_api_web_features_characters_get_all_get_all_character', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MOOGLEAPI_TEST_MOOGLE_API_WEB_FEATURES_CHARACTERS_GET_ALL_GET_ALL_CHARACTER_ENTID'];
...
//# sourceMappingURL=MoogleApiWebFeaturesCharactersGetAllGetAllCharacterDirect.test.js.map