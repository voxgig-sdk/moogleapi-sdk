...
(0, node_test_1.describe)('MoogleApiWebFeaturesMonstersSearchSearchMonsterDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-moogle_api_web_features_monsters_search_search_monster', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-moogle_api_web_features_monsters_search_search_monster', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MOOGLEAPI_TEST_MOOGLE_API_WEB_FEATURES_MONSTERS_SEARCH_SEARCH_MONSTER_ENTID'];
...
//# sourceMappingURL=MoogleApiWebFeaturesMonstersSearchSearchMonsterDirect.test.js.map