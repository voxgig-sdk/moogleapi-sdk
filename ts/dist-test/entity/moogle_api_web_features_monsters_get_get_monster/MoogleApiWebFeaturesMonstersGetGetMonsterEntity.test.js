...
(0, node_test_1.describe)('MoogleApiWebFeaturesMonstersGetGetMonsterEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        ...
        const ent = testsdk.MoogleApiWebFeaturesMonstersGetGetMonster();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let moogle_api_web_features_monsters_get_get_monster_ref01_data = Object.values(setup.data.existing.moogle_api_web_features_monsters_get_get_monster)[0];
        // LOAD
        const moogle_api_web_features_monsters_get_get_monster_ref01_ent = client.MoogleApiWebFeaturesMonstersGetGetMonster();
        const moogle_api_web_features_monsters_get_get_monster_ref01_match_dt0 = {};
        moogle_api_web_features_monsters_get_get_monster_ref01_match_dt0.id = moogle_api_web_features_monsters_get_get_monster_ref01_data.id;
        const moogle_api_web_features_monsters_get_get_monster_ref01_data_dt0 = (await moogle_api_web_features_monsters_get_get_monster_ref01_ent.load(moogle_api_web_features_monsters_get_get_monster_ref01_match_dt0)).data();
        (0, node_assert_1.default)(moogle_api_web_features_monsters_get_get_monster_ref01_data_dt0.id === moogle_api_web_features_monsters_get_get_monster_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/moogle_api_web_features_monsters_get_get_monster/MoogleApiWebFeaturesMonstersGetGetMonsterTestData.json');
    ...
    let idmap = transform(['moogle_api_web_features_monsters_get_get_monster01', 'moogle_api_web_features_monsters_get_get_monster02', 'moogle_api_web_features_monsters_get_get_monster03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=MoogleApiWebFeaturesMonstersGetGetMonsterEntity.test.js.map