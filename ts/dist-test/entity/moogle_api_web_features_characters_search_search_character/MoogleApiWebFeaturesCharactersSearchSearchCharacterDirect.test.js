...
(0, node_test_1.describe)('MoogleApiWebFeaturesCharactersSearchSearchCharacterDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-moogle_api_web_features_characters_search_search_character', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-moogle_api_web_features_characters_search_search_character', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MOOGLEAPI_TEST_MOOGLE_API_WEB_FEATURES_CHARACTERS_SEARCH_SEARCH_CHARACTER_ENTID'];
...
//# sourceMappingURL=MoogleApiWebFeaturesCharactersSearchSearchCharacterDirect.test.js.map