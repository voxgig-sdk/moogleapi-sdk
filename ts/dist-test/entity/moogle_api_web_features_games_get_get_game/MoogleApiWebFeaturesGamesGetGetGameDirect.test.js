...
(0, node_test_1.describe)('MoogleApiWebFeaturesGamesGetGetGameDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-moogle_api_web_features_games_get_get_game', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-moogle_api_web_features_games_get_get_game', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MOOGLEAPI_TEST_MOOGLE_API_WEB_FEATURES_GAMES_GET_GET_GAME_ENTID'];
...
//# sourceMappingURL=MoogleApiWebFeaturesGamesGetGetGameDirect.test.js.map