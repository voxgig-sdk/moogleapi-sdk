...
(0, node_test_1.describe)('MoogleApiWebFeaturesGamesGetAllGetAllGameDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-moogle_api_web_features_games_get_all_get_all_game', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-moogle_api_web_features_games_get_all_get_all_game', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MOOGLEAPI_TEST_MOOGLE_API_WEB_FEATURES_GAMES_GET_ALL_GET_ALL_GAME_ENTID'];
...
//# sourceMappingURL=MoogleApiWebFeaturesGamesGetAllGetAllGameDirect.test.js.map