...
(0, node_test_1.describe)('MoogleApiWebFeaturesMonstersGetAllGetAllMonsterDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MoogleapiSDK({
    ...
    (0, node_test_1.test)('direct-list-moogle_api_web_features_monsters_get_all_get_all_monster', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-moogle_api_web_features_monsters_get_all_get_all_monster', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.MOOGLEAPI_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MoogleapiSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.MOOGLEAPI_APIKEY,
        }));
        let idmap = env['MOOGLEAPI_TEST_MOOGLE_API_WEB_FEATURES_MONSTERS_GET_ALL_GET_ALL_MONSTER_ENTID'];
    ...
    const client = new __1.MoogleapiSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=MoogleApiWebFeaturesMonstersGetAllGetAllMonsterDirect.test.js.map