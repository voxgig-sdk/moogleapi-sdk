...
class MoogleapiGraphql
{
    ...
    // equivalent.
    public static function body(MoogleapiContext $ctx): mixed
    {
    ...
    public static function errors(MoogleapiContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
