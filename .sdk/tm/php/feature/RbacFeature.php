...
class MoogleapiRbacFeature extends MoogleapiBaseFeature
{
    ...
    private function _required(MoogleapiContext $ctx): ?string
    {
    ...
    private function _reject(MoogleapiContext $ctx, string $required): void
    {
    ...
    private function _track(MoogleapiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
