...
// Moogleapi SDK ratelimit feature
...
class MoogleapiRatelimitFeature extends MoogleapiBaseFeature
{
    ...
    private function _acquire(MoogleapiContext $ctx): void
    {
    ...
    private function _track(MoogleapiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
