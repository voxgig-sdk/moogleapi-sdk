...
// Moogleapi SDK streaming feature
...
class MoogleapiStreamingFeature extends MoogleapiBaseFeature
{
    ...
    private function _iterate(MoogleapiResult $result): \Generator
    {
    ...
    private function _streamable(MoogleapiContext $ctx): bool
    {
