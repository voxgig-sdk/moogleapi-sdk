...
// Moogleapi SDK clienttrack feature
...
class MoogleapiClienttrackFeature extends MoogleapiBaseFeature
{
    ...
    public function PostConstruct(MoogleapiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Moogleapi-SDK';
