...
class MoogleapiCacheFeature extends MoogleapiBaseFeature
{
    ...
    private function _through(MoogleapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
