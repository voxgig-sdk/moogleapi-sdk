...
class MoogleapiProxyFeature extends MoogleapiBaseFeature
{
    ...
    public function init(MoogleapiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MoogleapiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
