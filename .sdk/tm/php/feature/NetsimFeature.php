...
class MoogleapiNetsimFeature extends MoogleapiBaseFeature
{
    ...
    private function _simulate(MoogleapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MoogleapiContext $ctx, array $applied): void
    {
        $client = $this->client;
