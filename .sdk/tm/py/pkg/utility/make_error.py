# Moogleapi SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, MoogleapiError):
        errmsg = err.msg
    ...
    msg = "MoogleapiSDK: " + opname + ": " + errmsg
    ...
    sdk_err = MoogleapiError("", msg, ctx)
