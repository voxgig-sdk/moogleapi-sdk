...
from projectname_sdk.core.control import MoogleapiControl
...
class MoogleapiContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, MoogleapiSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MoogleapiResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MoogleapiResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return MoogleapiError(code, msg, self)
