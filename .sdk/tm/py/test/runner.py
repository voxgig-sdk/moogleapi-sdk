...
class MoogleapiTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MoogleapiTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = MoogleapiTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = MoogleapiTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
