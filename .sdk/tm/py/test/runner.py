...
class MoogleapiTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MoogleapiTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = MoogleapiTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = MoogleapiTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
