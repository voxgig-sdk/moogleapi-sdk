...
from projectname_sdk import MoogleapiSDK
from projectname_sdk.core.spec import MoogleapiSpec
from projectname_sdk.core.result import MoogleapiResult
from projectname_sdk.core.response import MoogleapiResponse
from projectname_sdk.core.operation import MoogleapiOperation
from projectname_sdk.core.error import MoogleapiError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import MoogleapiBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return MoogleapiError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = MoogleapiSDK.test(None, None)
        ...
        class TestInitFeature(MoogleapiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(MoogleapiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = MoogleapiSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = MoogleapiSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = MoogleapiSDK.test(None, setup_opts)
