...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = MoogleapiOmni.make_runner(TEST_JSON_FILE, MoogleapiSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : MoogleapiOmni.errify(err)
    end
