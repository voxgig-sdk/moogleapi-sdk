...
|---|---|---|
| `ts/` | @voxgig-sdk/moogleapi-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/moogleapi-sdk \
      --repository voxgig-sdk/moogleapi-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/moogleapi-sdk` shows it, and
`npm trust revoke @voxgig-sdk/moogleapi-sdk --id=<id>` removes it.
