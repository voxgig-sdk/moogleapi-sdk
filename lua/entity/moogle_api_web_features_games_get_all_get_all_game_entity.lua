-- Moogleapi SDK MoogleApiWebFeaturesGamesGetAllGetAllGame entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MoogleApiWebFeaturesGamesGetAllGetAllGameEntity = {}
MoogleApiWebFeaturesGamesGetAllGetAllGameEntity.__index = MoogleApiWebFeaturesGamesGetAllGetAllGameEntity


function MoogleApiWebFeaturesGamesGetAllGetAllGameEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MoogleApiWebFeaturesGamesGetAllGetAllGameEntity)
  self._name = "moogle_api_web_features_games_get_all_get_all_game"
  self._client = client
...
function MoogleApiWebFeaturesGamesGetAllGetAllGameEntity:get_name()
  return self._name
end


function MoogleApiWebFeaturesGamesGetAllGetAllGameEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MoogleApiWebFeaturesGamesGetAllGetAllGameEntity.new(self._client, opts)
end
...
function MoogleApiWebFeaturesGamesGetAllGetAllGameEntity:mark_deleted()
  self._deleted = true
end


function MoogleApiWebFeaturesGamesGetAllGetAllGameEntity:deleted()
  return true == self._deleted
end


function MoogleApiWebFeaturesGamesGetAllGetAllGameEntity:data_set(args)
  if args ~= nil then
...
function MoogleApiWebFeaturesGamesGetAllGetAllGameEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MoogleApiWebFeaturesGamesGetAllGetAllGameEntity:match_set(args)
  if args ~= nil then
...
function MoogleApiWebFeaturesGamesGetAllGetAllGameEntity:match_get()
...
function MoogleApiWebFeaturesGamesGetAllGetAllGameEntity:stream(action, args, callopts)
...
---@param reqmatch MoogleApiWebFeaturesGamesGetAllGetAllGameListMatch
---@param ctrl? table
---@return MoogleApiWebFeaturesGamesGetAllGetAllGame[]
---@return string? err
function MoogleApiWebFeaturesGamesGetAllGetAllGameEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function MoogleApiWebFeaturesGamesGetAllGetAllGameEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MoogleApiWebFeaturesGamesGetAllGetAllGameEntity
