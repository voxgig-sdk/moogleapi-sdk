-- Moogleapi SDK MoogleApiWebFeaturesCharactersGetAllGetAllCharacter entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity = {}
MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity.__index = MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity


function MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity)
  self._name = "moogle_api_web_features_characters_get_all_get_all_character"
  self._client = client
...
function MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity:get_name()
  return self._name
end


function MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity.new(self._client, opts)
end
...
function MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity:mark_deleted()
  self._deleted = true
end


function MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity:deleted()
  return true == self._deleted
end


function MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity:data_set(args)
  if args ~= nil then
...
function MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity:match_set(args)
  if args ~= nil then
...
function MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity:match_get()
...
function MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity:stream(action, args, callopts)
...
---@param reqmatch MoogleApiWebFeaturesCharactersGetAllGetAllCharacterListMatch
---@param ctrl? table
---@return MoogleApiWebFeaturesCharactersGetAllGetAllCharacter[]
---@return string? err
function MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity
