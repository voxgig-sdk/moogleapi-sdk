...
local MoogleApiWebFeaturesGamesGetGetGameEntity = {}
MoogleApiWebFeaturesGamesGetGetGameEntity.__index = MoogleApiWebFeaturesGamesGetGetGameEntity


function MoogleApiWebFeaturesGamesGetGetGameEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MoogleApiWebFeaturesGamesGetGetGameEntity)
  self._name = "moogle_api_web_features_games_get_get_game"
  self._client = client
...
function MoogleApiWebFeaturesGamesGetGetGameEntity:get_name()
  return self._name
end


function MoogleApiWebFeaturesGamesGetGetGameEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MoogleApiWebFeaturesGamesGetGetGameEntity.new(self._client, opts)
end
...
function MoogleApiWebFeaturesGamesGetGetGameEntity:mark_deleted()
  self._deleted = true
end


function MoogleApiWebFeaturesGamesGetGetGameEntity:deleted()
  return true == self._deleted
end


function MoogleApiWebFeaturesGamesGetGetGameEntity:data_set(args)
  if args ~= nil then
...
function MoogleApiWebFeaturesGamesGetGetGameEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MoogleApiWebFeaturesGamesGetGetGameEntity:match_set(args)
  if args ~= nil then
...
function MoogleApiWebFeaturesGamesGetGetGameEntity:match_get()
...
function MoogleApiWebFeaturesGamesGetGetGameEntity:stream(action, args, callopts)
...
function MoogleApiWebFeaturesGamesGetGetGameEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MoogleApiWebFeaturesGamesGetGetGameEntity
