-- Moogleapi SDK MoogleApiWebFeaturesCharactersGetGetCharacter entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MoogleApiWebFeaturesCharactersGetGetCharacterEntity = {}
MoogleApiWebFeaturesCharactersGetGetCharacterEntity.__index = MoogleApiWebFeaturesCharactersGetGetCharacterEntity


function MoogleApiWebFeaturesCharactersGetGetCharacterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MoogleApiWebFeaturesCharactersGetGetCharacterEntity)
  self._name = "moogle_api_web_features_characters_get_get_character"
  self._client = client
...
function MoogleApiWebFeaturesCharactersGetGetCharacterEntity:get_name()
  return self._name
end


function MoogleApiWebFeaturesCharactersGetGetCharacterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MoogleApiWebFeaturesCharactersGetGetCharacterEntity.new(self._client, opts)
end
...
function MoogleApiWebFeaturesCharactersGetGetCharacterEntity:mark_deleted()
  self._deleted = true
end


function MoogleApiWebFeaturesCharactersGetGetCharacterEntity:deleted()
  return true == self._deleted
end


function MoogleApiWebFeaturesCharactersGetGetCharacterEntity:data_set(args)
  if args ~= nil then
...
function MoogleApiWebFeaturesCharactersGetGetCharacterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MoogleApiWebFeaturesCharactersGetGetCharacterEntity:match_set(args)
  if args ~= nil then
...
function MoogleApiWebFeaturesCharactersGetGetCharacterEntity:match_get()
...
function MoogleApiWebFeaturesCharactersGetGetCharacterEntity:stream(action, args, callopts)
...
---@param reqmatch MoogleApiWebFeaturesCharactersGetGetCharacterLoadMatch
---@param ctrl? table
---@return MoogleApiWebFeaturesCharactersGetGetCharacter
---@return string? err
function MoogleApiWebFeaturesCharactersGetGetCharacterEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function MoogleApiWebFeaturesCharactersGetGetCharacterEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MoogleApiWebFeaturesCharactersGetGetCharacterEntity
