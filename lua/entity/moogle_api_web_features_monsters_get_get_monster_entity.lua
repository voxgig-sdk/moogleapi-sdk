-- Moogleapi SDK MoogleApiWebFeaturesMonstersGetGetMonster entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MoogleApiWebFeaturesMonstersGetGetMonsterEntity = {}
MoogleApiWebFeaturesMonstersGetGetMonsterEntity.__index = MoogleApiWebFeaturesMonstersGetGetMonsterEntity


function MoogleApiWebFeaturesMonstersGetGetMonsterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MoogleApiWebFeaturesMonstersGetGetMonsterEntity)
  self._name = "moogle_api_web_features_monsters_get_get_monster"
  self._client = client
...
function MoogleApiWebFeaturesMonstersGetGetMonsterEntity:get_name()
  return self._name
end


function MoogleApiWebFeaturesMonstersGetGetMonsterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MoogleApiWebFeaturesMonstersGetGetMonsterEntity.new(self._client, opts)
end
...
function MoogleApiWebFeaturesMonstersGetGetMonsterEntity:mark_deleted()
  self._deleted = true
end


function MoogleApiWebFeaturesMonstersGetGetMonsterEntity:deleted()
  return true == self._deleted
end


function MoogleApiWebFeaturesMonstersGetGetMonsterEntity:data_set(args)
  if args ~= nil then
...
function MoogleApiWebFeaturesMonstersGetGetMonsterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MoogleApiWebFeaturesMonstersGetGetMonsterEntity:match_set(args)
  if args ~= nil then
...
function MoogleApiWebFeaturesMonstersGetGetMonsterEntity:match_get()
...
function MoogleApiWebFeaturesMonstersGetGetMonsterEntity:stream(action, args, callopts)
...
---@param reqmatch MoogleApiWebFeaturesMonstersGetGetMonsterLoadMatch
---@param ctrl? table
---@return MoogleApiWebFeaturesMonstersGetGetMonster
---@return string? err
function MoogleApiWebFeaturesMonstersGetGetMonsterEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function MoogleApiWebFeaturesMonstersGetGetMonsterEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MoogleApiWebFeaturesMonstersGetGetMonsterEntity
