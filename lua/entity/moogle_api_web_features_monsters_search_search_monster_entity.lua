-- Moogleapi SDK MoogleApiWebFeaturesMonstersSearchSearchMonster entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity = {}
MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity.__index = MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity


function MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity)
  self._name = "moogle_api_web_features_monsters_search_search_monster"
  self._client = client
...
function MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity:get_name()
  return self._name
end


function MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity.new(self._client, opts)
end
...
function MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity:mark_deleted()
  self._deleted = true
end


function MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity:deleted()
  return true == self._deleted
end


function MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity:data_set(args)
  if args ~= nil then
...
function MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity:match_set(args)
  if args ~= nil then
...
function MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity:match_get()
...
function MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity:stream(action, args, callopts)
...
---@param reqmatch MoogleApiWebFeaturesMonstersSearchSearchMonsterListMatch
---@param ctrl? table
---@return MoogleApiWebFeaturesMonstersSearchSearchMonster[]
---@return string? err
function MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity
