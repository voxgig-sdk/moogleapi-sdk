...
local MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity = {}
MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity.__index = MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity


function MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity)
  self._name = "moogle_api_web_features_monsters_get_all_get_all_monster"
  self._client = client
...
function MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity:get_name()
  return self._name
end


function MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity.new(self._client, opts)
end
...
function MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity:mark_deleted()
  self._deleted = true
end


function MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity:deleted()
  return true == self._deleted
end


function MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity:data_set(args)
  if args ~= nil then
...
function MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity:match_set(args)
  if args ~= nil then
...
function MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity:match_get()
...
function MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity:stream(action, args, callopts)
...
function MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity
