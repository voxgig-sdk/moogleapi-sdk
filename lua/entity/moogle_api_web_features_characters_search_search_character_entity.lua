...
local MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity = {}
MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity.__index = MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity


function MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity)
  self._name = "moogle_api_web_features_characters_search_search_character"
  self._client = client
...
function MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity:get_name()
  return self._name
end


function MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity.new(self._client, opts)
end
...
function MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity:mark_deleted()
  self._deleted = true
end


function MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity:deleted()
  return true == self._deleted
end


function MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity:data_set(args)
  if args ~= nil then
...
function MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity:match_set(args)
  if args ~= nil then
...
function MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity:match_get()
...
function MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity:stream(action, args, callopts)
...
function MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity
