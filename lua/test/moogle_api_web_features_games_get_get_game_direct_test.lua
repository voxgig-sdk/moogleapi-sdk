...
describe("MoogleApiWebFeaturesGamesGetGetGameDirect", function()
  it("should direct-load-moogle_api_web_features_games_get_get_game", function()
    local setup = moogle_api_web_features_games_get_get_game_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-moogle_api_web_features_games_get_get_game", setup.live and "live" or "unit")
...
function moogle_api_web_features_games_get_get_game_direct_setup(mockres)
