...
describe("MoogleApiWebFeaturesMonstersGetGetMonsterEntity", function()
  ...
  it("should run basic flow", function()
    ...
    assert.is_nil(err)
    local moogle_api_web_features_monsters_get_get_monster_ref01_data_dt0_load_result = helpers.to_map(type(moogle_api_web_features_monsters_get_get_monster_ref01_data_dt0_loaded) == 'table' and moogle_api_web_features_monsters_get_get_monster_ref01_data_dt0_loaded.data_get and moogle_api_web_features_monsters_get_get_monster_ref01_data_dt0_loaded:data_get() or moogle_api_web_features_monsters_get_get_monster_ref01_data_dt0_loaded)
