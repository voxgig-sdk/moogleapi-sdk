...
describe("MoogleApiWebFeaturesMonstersGetGetMonsterDirect", function()
  it("should direct-load-moogle_api_web_features_monsters_get_get_monster", function()
    local setup = moogle_api_web_features_monsters_get_get_monster_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-moogle_api_web_features_monsters_get_get_monster", setup.live and "live" or "unit")
...
function moogle_api_web_features_monsters_get_get_monster_direct_setup(mockres)
