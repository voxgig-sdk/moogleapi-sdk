...
describe("MoogleApiWebFeaturesMonstersSearchSearchMonsterDirect", function()
  it("should direct-list-moogle_api_web_features_monsters_search_search_monster", function()
    local setup = moogle_api_web_features_monsters_search_search_monster_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-moogle_api_web_features_monsters_search_search_monster", setup.live and "live" or "unit")
