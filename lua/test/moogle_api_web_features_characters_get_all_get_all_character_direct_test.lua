...
describe("MoogleApiWebFeaturesCharactersGetAllGetAllCharacterDirect", function()
  it("should direct-list-moogle_api_web_features_characters_get_all_get_all_character", function()
    local setup = moogle_api_web_features_characters_get_all_get_all_character_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-moogle_api_web_features_characters_get_all_get_all_character", setup.live and "live" or "unit")
...
function moogle_api_web_features_characters_get_all_get_all_character_direct_setup(mockres)
