...
describe("MoogleApiWebFeaturesCharactersGetGetCharacterDirect", function()
  it("should direct-load-moogle_api_web_features_characters_get_get_character", function()
    local setup = moogle_api_web_features_characters_get_get_character_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-moogle_api_web_features_characters_get_get_character", setup.live and "live" or "unit")
