...
**Entities** (8): `MoogleApiWebFeaturesCharactersGetAllGetAllCharacter`, `MoogleApiWebFeaturesCharactersGetGetCharacter`, `MoogleApiWebFeaturesCharactersSearchSearchCharacter`, `MoogleApiWebFeaturesGamesGetAllGetAllGame`, `MoogleApiWebFeaturesGamesGetGetGame`, `MoogleApiWebFeaturesMonstersGetAllGetAllMonster`, `MoogleApiWebFeaturesMonstersGetGetMonster`, `MoogleApiWebFeaturesMonstersSearchSearchMonster`.
