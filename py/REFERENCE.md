...
```python
results = client.MoogleApiWebFeaturesCharactersSearchSearchCharacter().list({"query": "example"})
...
```python
results = client.MoogleApiWebFeaturesMonstersSearchSearchMonster().list({"query": "example"})
