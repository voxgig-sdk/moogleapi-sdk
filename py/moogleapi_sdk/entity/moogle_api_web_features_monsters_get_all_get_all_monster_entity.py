...
class MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity(self._client, opts)
    ...
    def data_get(self) -> MoogleApiWebFeaturesMonstersGetAllGetAllMonster:
    ...
    def match_get(self) -> MoogleApiWebFeaturesMonstersGetAllGetAllMonster:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MoogleApiWebFeaturesMonstersGetAllGetAllMonster]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MoogleApiWebFeaturesMonstersGetAllGetAllMonster().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
