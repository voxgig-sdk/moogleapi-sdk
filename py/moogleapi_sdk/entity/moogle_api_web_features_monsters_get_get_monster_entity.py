...
class MoogleApiWebFeaturesMonstersGetGetMonsterEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MoogleApiWebFeaturesMonstersGetGetMonsterEntity(self._client, opts)
    ...
    def data_get(self) -> MoogleApiWebFeaturesMonstersGetGetMonster:
    ...
    def match_get(self) -> MoogleApiWebFeaturesMonstersGetGetMonster:
    ...
    def load(self, reqmatch=None, ctrl=None) -> MoogleApiWebFeaturesMonstersGetGetMonster:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.MoogleApiWebFeaturesMonstersGetGetMonster().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
