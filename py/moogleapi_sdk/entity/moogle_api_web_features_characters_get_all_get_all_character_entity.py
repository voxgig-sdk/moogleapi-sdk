...
from moogleapi_sdk.moogleapi_types import (
    MoogleApiWebFeaturesCharactersGetAllGetAllCharacter,
    MoogleApiWebFeaturesCharactersGetAllGetAllCharacterListMatch,
)
...
class MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity(self._client, opts)
    ...
    def data_get(self) -> MoogleApiWebFeaturesCharactersGetAllGetAllCharacter:
    ...
    def match_get(self) -> MoogleApiWebFeaturesCharactersGetAllGetAllCharacter:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MoogleApiWebFeaturesCharactersGetAllGetAllCharacter]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MoogleApiWebFeaturesCharactersGetAllGetAllCharacter().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
