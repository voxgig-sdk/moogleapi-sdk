...
class MoogleApiWebFeaturesCharactersGetGetCharacterEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MoogleApiWebFeaturesCharactersGetGetCharacterEntity(self._client, opts)
    ...
    def data_get(self) -> MoogleApiWebFeaturesCharactersGetGetCharacter:
    ...
    def match_get(self) -> MoogleApiWebFeaturesCharactersGetGetCharacter:
    ...
    def load(self, reqmatch=None, ctrl=None) -> MoogleApiWebFeaturesCharactersGetGetCharacter:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.MoogleApiWebFeaturesCharactersGetGetCharacter().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
