...
from moogleapi_sdk.moogleapi_types import (
    ...
    MoogleApiWebFeaturesCharactersSearchSearchCharacterListMatch,
)
...
class MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity(self._client, opts)
    ...
    def data_get(self) -> MoogleApiWebFeaturesCharactersSearchSearchCharacter:
    ...
    def match_get(self) -> MoogleApiWebFeaturesCharactersSearchSearchCharacter:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MoogleApiWebFeaturesCharactersSearchSearchCharacter]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MoogleApiWebFeaturesCharactersSearchSearchCharacter().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
