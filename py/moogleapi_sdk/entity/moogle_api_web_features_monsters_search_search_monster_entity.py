...
from moogleapi_sdk.moogleapi_types import (
    ...
    MoogleApiWebFeaturesMonstersSearchSearchMonsterListMatch,
)
...
class MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity(self._client, opts)
    ...
    def data_get(self) -> MoogleApiWebFeaturesMonstersSearchSearchMonster:
    ...
    def match_get(self) -> MoogleApiWebFeaturesMonstersSearchSearchMonster:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MoogleApiWebFeaturesMonstersSearchSearchMonster]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MoogleApiWebFeaturesMonstersSearchSearchMonster().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
