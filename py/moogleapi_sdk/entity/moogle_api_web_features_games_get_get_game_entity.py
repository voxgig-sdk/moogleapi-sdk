...
class MoogleApiWebFeaturesGamesGetGetGameEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MoogleApiWebFeaturesGamesGetGetGameEntity(self._client, opts)
    ...
    def data_get(self) -> MoogleApiWebFeaturesGamesGetGetGame:
    ...
    def match_get(self) -> MoogleApiWebFeaturesGamesGetGetGame:
    ...
    def load(self, reqmatch=None, ctrl=None) -> MoogleApiWebFeaturesGamesGetGetGame:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.MoogleApiWebFeaturesGamesGetGetGame().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
