...
class MoogleApiWebFeaturesGamesGetAllGetAllGameEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MoogleApiWebFeaturesGamesGetAllGetAllGameEntity(self._client, opts)
    ...
    def data_get(self) -> MoogleApiWebFeaturesGamesGetAllGetAllGame:
    ...
    def match_get(self) -> MoogleApiWebFeaturesGamesGetAllGetAllGame:
