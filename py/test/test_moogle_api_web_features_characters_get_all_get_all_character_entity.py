...
class TestMoogleApiWebFeaturesCharactersGetAllGetAllCharacterEntity:
    ...
    def test_should_stream(self):
        ...
        seen = list(base.MoogleApiWebFeaturesCharactersGetAllGetAllCharacter(None).stream("list", None, None))
        assert len(seen) == 3
        ...
        if isinstance(cfg.get("feature"), dict) and "streaming" in cfg["feature"]:
            ...
            got = []
            for item in sdk.MoogleApiWebFeaturesCharactersGetAllGetAllCharacter(None).stream("list", None, None):
    ...
    def test_should_run_basic_flow(self):
        ...
        moogle_api_web_features_characters_get_all_get_all_character_ref01_list_result = moogle_api_web_features_characters_get_all_get_all_character_ref01_ent.list(moogle_api_web_features_characters_get_all_get_all_character_ref01_match, None)
