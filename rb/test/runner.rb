...
module MoogleapiTestRunner
  ...
  def self.env_override(m)
    live = getenv("MOOGLEAPI_TEST_LIVE")
    override = getenv("MOOGLEAPI_TEST_OVERRIDE")
    ...
    explain = getenv("MOOGLEAPI_TEST_EXPLAIN")
    m["MOOGLEAPI_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = MoogleapiTestRunner
Helpers = MoogleapiHelpers
Vs = VoxgigStruct
