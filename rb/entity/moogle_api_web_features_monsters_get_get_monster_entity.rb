...
class MoogleApiWebFeaturesMonstersGetGetMonsterEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "moogle_api_web_features_monsters_get_get_monster"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    MoogleApiWebFeaturesMonstersGetGetMonsterEntity.new(@_client, opts)
  end
  ...
  # @return [MoogleApiWebFeaturesMonstersGetGetMonster, Hash] the current MoogleApiWebFeaturesMonstersGetGetMonster data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MoogleApiWebFeaturesMonstersGetGetMonster fields)
  def match_get
  ...
  #
  # @param reqmatch [MoogleApiWebFeaturesMonstersGetGetMonsterLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.MoogleApiWebFeaturesMonstersGetGetMonster.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [MoogleApiWebFeaturesMonstersGetGetMonster, Hash] the loaded MoogleApiWebFeaturesMonstersGetGetMonster; raises MoogleapiError on failure
