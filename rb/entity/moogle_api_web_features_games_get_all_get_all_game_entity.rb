...
class MoogleApiWebFeaturesGamesGetAllGetAllGameEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "moogle_api_web_features_games_get_all_get_all_game"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    MoogleApiWebFeaturesGamesGetAllGetAllGameEntity.new(@_client, opts)
  end
  ...
  # @return [MoogleApiWebFeaturesGamesGetAllGetAllGame, Hash] the current MoogleApiWebFeaturesGamesGetAllGetAllGame data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MoogleApiWebFeaturesGamesGetAllGetAllGame fields)
  def match_get
  ...
  #
  # @param reqmatch [MoogleApiWebFeaturesGamesGetAllGetAllGameListMatch, Hash, nil] match filter (any subset of
  #   MoogleApiWebFeaturesGamesGetAllGetAllGame fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<MoogleApiWebFeaturesGamesGetAllGetAllGame>, Array] the matching MoogleApiWebFeaturesGamesGetAllGetAllGame items; raises MoogleapiError on failure
