...
class MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "moogle_api_web_features_monsters_search_search_monster"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    MoogleApiWebFeaturesMonstersSearchSearchMonsterEntity.new(@_client, opts)
  end
  ...
  # @return [MoogleApiWebFeaturesMonstersSearchSearchMonster, Hash] the current MoogleApiWebFeaturesMonstersSearchSearchMonster data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MoogleApiWebFeaturesMonstersSearchSearchMonster fields)
  def match_get
  ...
  #
  # @param reqmatch [MoogleApiWebFeaturesMonstersSearchSearchMonsterListMatch, Hash, nil] match filter (any subset of
  #   MoogleApiWebFeaturesMonstersSearchSearchMonster fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<MoogleApiWebFeaturesMonstersSearchSearchMonster>, Array] the matching MoogleApiWebFeaturesMonstersSearchSearchMonster items; raises MoogleapiError on failure
