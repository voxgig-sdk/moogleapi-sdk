...
class MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "moogle_api_web_features_monsters_get_all_get_all_monster"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    MoogleApiWebFeaturesMonstersGetAllGetAllMonsterEntity.new(@_client, opts)
  end
  ...
  # @return [MoogleApiWebFeaturesMonstersGetAllGetAllMonster, Hash] the current MoogleApiWebFeaturesMonstersGetAllGetAllMonster data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MoogleApiWebFeaturesMonstersGetAllGetAllMonster fields)
  def match_get
  ...
  #
  # @param reqmatch [MoogleApiWebFeaturesMonstersGetAllGetAllMonsterListMatch, Hash, nil] match filter (any subset of
  #   MoogleApiWebFeaturesMonstersGetAllGetAllMonster fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<MoogleApiWebFeaturesMonstersGetAllGetAllMonster>, Array] the matching MoogleApiWebFeaturesMonstersGetAllGetAllMonster items; raises MoogleapiError on failure
