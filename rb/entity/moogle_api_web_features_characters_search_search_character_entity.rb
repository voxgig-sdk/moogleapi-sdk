...
class MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "moogle_api_web_features_characters_search_search_character"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    MoogleApiWebFeaturesCharactersSearchSearchCharacterEntity.new(@_client, opts)
  end
  ...
  # @return [MoogleApiWebFeaturesCharactersSearchSearchCharacter, Hash] the current MoogleApiWebFeaturesCharactersSearchSearchCharacter data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MoogleApiWebFeaturesCharactersSearchSearchCharacter fields)
  def match_get
  ...
  #
  # @param reqmatch [MoogleApiWebFeaturesCharactersSearchSearchCharacterListMatch, Hash, nil] match filter (any subset of
  #   MoogleApiWebFeaturesCharactersSearchSearchCharacter fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<MoogleApiWebFeaturesCharactersSearchSearchCharacter>, Array] the matching MoogleApiWebFeaturesCharactersSearchSearchCharacter items; raises MoogleapiError on failure
