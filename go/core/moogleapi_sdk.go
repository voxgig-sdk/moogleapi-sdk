...
func (sdk *MoogleapiSDK) OptionsMap() map[string]any {
...
func (sdk *MoogleapiSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *MoogleapiSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *MoogleapiSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MoogleapiSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *MoogleapiSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *MoogleapiSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("MoogleapiSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *MoogleapiSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MoogleapiSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("MoogleapiSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
