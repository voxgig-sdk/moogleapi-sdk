...
The Golang SDK for the Moogleapi API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/moogleapi-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/moogleapi-sdk=../path/to/github.com/voxgig-sdk/moogleapi-sdk
```
...
```
github.com/voxgig-sdk/moogleapi-sdk/
...
The root package (`github.com/voxgig-sdk/moogleapi-sdk`) re-exports everything needed
