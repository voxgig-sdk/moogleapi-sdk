...
const testSeed = `map[string]any{"entity": map[string]any{"moogle_api_web_features_characters_get_all_get_all_character": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "moogle_api_web_features_characters_get_get_character": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "moogle_api_web_features_characters_search_search_character": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "moogle_api_web_features_games_get_all_get_all_game": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "moogle_api_web_features_games_get_get_game": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "moogle_api_web_features_monsters_get_all_get_all_monster": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "moogle_api_web_features_monsters_get_get_monster": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "moogle_api_web_features_monsters_search_search_monster": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
