...
func TestMoogleApiWebFeaturesCharactersSearchSearchCharacterEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		moogleApiWebFeaturesCharactersSearchSearchCharacterRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.moogle_api_web_features_characters_search_search_character")))
